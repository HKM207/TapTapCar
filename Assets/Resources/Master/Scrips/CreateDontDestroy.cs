...
public class CreateDontDestroy : MonoBehaviour
{
    ...
    {
        if (Variables.cars != null) // Das hier muss die Liste der Cars einlesen und f�r jedes Car ein Element instantiaten und das Car da rein �bergeben.
        {
            foreach (Car car in Variables.cars)
            {
                //SN: Create the Car UI Elements together with the cars.
                //GameObject scrollListCars = GameObject.Find("CarUIScrollListContents"); // Script sollte man evtl. direkt an dieses Ding h�ngen.
                GameObject element;
